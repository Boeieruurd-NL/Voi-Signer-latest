...
const tx = {
  ...
  "sender-rewards": 0,
  "signature": {
    "sig": "ZNzEA9U60EQ9w7kZct4t/PyhoE1NYWar6kLJskCIAgfDP4tePFmYdADjNpDcThsRAwSWu0rkRkl+j9WS5br/Aw=="
  },
  "tx-type": "pay"
};
...
describe('TxPay', () => {
  ...
  it('should display receiver', () => {
    expect(component.contains(html`<span>${tx['payment-transaction'].receiver}</span>`)).toBe(true);
  });
